      ...
      <div class="container-fluid">
          ...
          <div id="home" class="main_contents">
            ...
            <div class="row">
                  ...
                  <div class="col-sm-4">
                      <div class="card img-narrow">
                          <a href="../application/assets/images/renderImages/fanta.png" data-fancybox data-caption="My 3D Fanta Cup Render" class="thumbnail">
                          ...
                          <div class="card-body">
                            ...
                            <a href="http://www.coca-cola.co.uk/brands/fanta" class="btn btn-primary btn-responsive">Find out more ...</a>
                          </div>
                      </div>
                  </div>
            </div>
          ...
          <h1>About</h1>
          Web 3D Applications is a final year undergraduate and post-graduate module. This 3D Web Application aims to show the knowledge and skills I gathered overt the course of this module. </br> </br>

          The 'Models' page shows x3d models I designed and rendered in Blender for a Coca Cola can, Sprite glass bottle and Fanta cup. The models are textured with different materials, and shaders using normal and roughness maps</br> </br>

          The models are animated to rotate, have cameras set-up from different angles, as well as lights and rendering options to chose from.</br> </br>

          The code and models are available for download from my Github repository <a href="https://github.com/h0nter/web.3d.application">HERE</a> </br> </br>

          <h1>Statement of Originality</h1>
          <p>
          These web pages are submitted as part requirement for the degree of MComp Computer Science (with an Industrial Placement Year) at the University of Sussex. They are the product of my own labour except where indicated in the web page content. These web pages or contents may be freely copied and distributed provided the source is acknowledged". 
          </p>
          </div>  
                          ...
                          <x3d id="wire">
                            <scene>
                                <Switch whichChoice="0" id='SceneSwitch'>
                                    <transform>
                                        <inline nameSpaceName="model" mapDEFToID="true" onclick="animateCan();" url="../application/assets/x3d/can.x3d" > </inline>
                                    </transform>
                                    <transform>
                                        <inline nameSpaceName="model" mapDEFToID="true" onclick="animateBottle();" url="../application/assets/x3d/bottle.x3d"> </inline>
                                    </transform>
                                    <transform>
                                        <inline nameSpaceName="model" mapDEFToID="true" onclick="animateCup();" url="../application/assets/x3d/cup.x3d"> </inline>
                                    </transform>
                                </Switch>
                            </scene>
                          </x3d>
                    ...
                    <div class="card text-left">
                        ...
                        <div class="card-body">
                          ...
                          <div class="card-text x3dAnimationDescription drinksText">
                              <p>These buttons start and stop an X3D animation</p>
                          </div>
                        </div>
                      </div>
                </div>
                        ...
                        <div class="card-header">
                          ...
                          <li class="nav-item dropdown">
                              ...
                              <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="#" onclick="omniLight();">Point lights On/Off</a>
              ...
              <div class="col-sm-12">
                  <div class="card">
                      <div class="card-body">
                        ...
                        <a href="http://www.coca-cola.co.uk/brands/fanta" class="btn btn-primary btn-responisve">Visit Fanta.</a>                 
                      </div>
                  </div>
              </div>
      ...
      <nav id="footerColor" class="navbar navbar-expand-sm footer">
          <div class="container-fluid">
                <div class="navbar-text float-left copyright">
                    <p><span class="align-baseline">&copy 2022 CandNo. 198708 | <a href="javascript:changeLook()">Restyle</a> | <a href="javascript:changeBack()">Reset</a> | <a href="https://github.com/h0nter/web.3d.application">Github</a> | <a href="https://github.com/h0nter/web.3d.application/tree/alpha/Blender_projects">3D Models Archive</a> </span></p>
                </div>
                <div class="navbar-text float-right social">
                    <a href="#"><i class="fab fa-facebook-square fa-2x"></i></a>
                    <a href="#"><i class="fab fa-twitter fa-2x"></i></a>
                    <a href="#"><i class="fab fa-google-plus fa-2x"></i></a>
                    <a href="https://github.com/h0nter/web.3d.application"><i class="fab fa-github-square fa-2x"></i></a>
                </div>
          </div>
      </nav> 
          ...
          <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>CandNo. 198708, Email: tjm44@sussex.ac.uk</p>
                </div>
